...
import { INITIAL_SERVICE_STATE } from '../../utils/constants.js'; 
import { getDbPaths } from '../../services/firebase.js'; 
import { useTranslation } from '../../context/TranslationContext.jsx';

const FinanceServiceForm = ({ userId, db, mode = 'add', initialData = null, onClose, role }) => { 
    ...
    const formTitle = mode === 'edit' ? t('finance.services.form_edit') : t('finance.services.form_add');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error(`Error ${mode} service: `, error);
        ...
        <div className="rounded-2xl border border-slate-200 bg-white shadow-xl overflow-hidden max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <InputField label={t('finance.col.client')} name="client" value={String(formData.client ?? '')} onChange={handleChange} disabled={!isAdmin} />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
